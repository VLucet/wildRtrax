# Contributing to wildrtrax

This outlines how to propose a change to wildrtrax.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ABbiodiversity/wildrtrax", fork = TRUE)`.
...
Please note that the wildRtrax project is released with a [Contributor
Code of
Conduct](https://abbiodiversity.github.io/wildrtrax/CODE_OF_CONDUCT.md).
